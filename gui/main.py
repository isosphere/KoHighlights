...
class Ui_Base(object):
    def setupUi(self, Base):
        ...
        Base.resize(640, 512)
        icon = QIcon()
        icon.addFile(u":/logo64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/files_view.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/description.png", QSize(), QIcon.Normal, QIcon.Off)
