...
(EXPORT_TEXT_MANY, EXPORT_TEXT_COMBINED, EXPORT_HTML_MANY, EXPORT_HTML_COMBINED,
 EXPORT_CSV_MANY, EXPORT_CSV_COMBINED, EXPORT_MD_MANY, EXPORT_MD_COMBINED, EXPORT_TEMPLATE,) = range(9)  # save_actions
